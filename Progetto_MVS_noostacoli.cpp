/******************************
  Program "Progetto_MVS_noostacoli.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "Progetto_MVS_noostacoli"
...
bool mu__boolexpr5;
bool mu__boolexpr6;
  if (!((mu_labirinto[mu_i][mu_j]) == (mu_Vuoto))) mu__boolexpr6 = FALSE ;
  else {
bool mu__boolexpr7;
  if ((mu_i) != (0)) mu__boolexpr7 = TRUE ;
  else {
  mu__boolexpr7 = ((mu_j) != (mu_USCITA_Y)) ; 
}
...
bool mu__boolexpr8;
  if ((mu_i) != (mu_USCITA_X)) mu__boolexpr8 = TRUE ;
  else {
  mu__boolexpr8 = ((mu_j) != (8)) ; 
}
  mu__boolexpr5 = (mu__boolexpr8) ; 
}
  if (!(mu__boolexpr5)) mu__boolexpr4 = FALSE ;
  else {
bool mu__boolexpr9;
  if ((mu_i) != (2)) mu__boolexpr9 = TRUE ;
  else {
  mu__boolexpr9 = ((mu_j) != (mu_USCITA_Y)) ; 
}
  mu__boolexpr4 = (mu__boolexpr9) ; 
}
  if (!(mu__boolexpr4)) mu__boolexpr3 = FALSE ;
  else {
bool mu__boolexpr10;
  if ((mu_i) != (mu_USCITA_X)) mu__boolexpr10 = TRUE ;
  else {
  mu__boolexpr10 = ((mu_j) != (10)) ; 
}
  mu__boolexpr3 = (mu__boolexpr10) ; 
}
if ( mu__boolexpr3 )
{
mu_labirinto[mu_i][mu_j] = mu_Ostacolo;
}
}
};
};
...
{
bool mu__boolexpr11;
  if (!((mu_x) == (mu_w))) mu__boolexpr11 = FALSE ;
  else {
  mu__boolexpr11 = ((mu_y) == (mu_z)) ; 
}
if ( mu__boolexpr11 )
{
mu_cattura = mu_true;
...
bool mu__boolexpr15;
bool mu__boolexpr16;
  if (!(!(mu_topoUscito))) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr16)) mu__boolexpr15 = FALSE ;
  else {
bool mu__boolexpr17;
  if (((mu_y) - (mu_z)) < (0)) mu__boolexpr17 = TRUE ;
  else {
bool mu__boolexpr18;
bool mu__boolexpr19;
bool mu__boolexpr20;
bool mu__boolexpr21;
  if (!(((mu_y) - (mu_z)) > (0))) mu__boolexpr21 = FALSE ;
  else {
bool mu__boolexpr22;
  if ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Ostacolo)) mu__boolexpr22 = TRUE ;
  else {
  mu__boolexpr22 = ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr21 = (mu__boolexpr22) ; 
}
  if (mu__boolexpr21) mu__boolexpr20 = TRUE ;
  else {
  mu__boolexpr20 = (((mu_y) - (mu_z)) <= (0)) ; 
}
  if (!(mu__boolexpr20)) mu__boolexpr19 = FALSE ;
  else {
bool mu__boolexpr23;
bool mu__boolexpr24;
  if (!(((mu_x) - (mu_w)) < (0))) mu__boolexpr24 = FALSE ;
  else {
bool mu__boolexpr25;
  if ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr25 = TRUE ;
  else {
  mu__boolexpr25 = ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr24 = (mu__boolexpr25) ; 
}
  if (mu__boolexpr24) mu__boolexpr23 = TRUE ;
  else {
  mu__boolexpr23 = (((mu_x) - (mu_w)) >= (0)) ; 
}
...
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!(((mu_x) - (mu_w)) > (0))) mu__boolexpr27 = FALSE ;
  else {
bool mu__boolexpr28;
  if ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr28 = TRUE ;
  else {
  mu__boolexpr28 = ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr27 = (mu__boolexpr28) ; 
}
  if (mu__boolexpr27) mu__boolexpr26 = TRUE ;
  else {
  mu__boolexpr26 = (((mu_x) - (mu_w)) <= (0)) ; 
}
  mu__boolexpr18 = (mu__boolexpr26) ; 
}
  mu__boolexpr17 = (mu__boolexpr18) ; 
}
  mu__boolexpr15 = (mu__boolexpr17) ; 
}
  if (!(mu__boolexpr15)) mu__boolexpr14 = FALSE ;
  else {
  mu__boolexpr14 = ((mu_stop) == (2)) ; 
}
  if (!(mu__boolexpr14)) mu__boolexpr13 = FALSE ;
  else {
  mu__boolexpr13 = ((mu_labirinto[mu_w][(mu_z) - (1)]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr13)) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = ((mu_labirinto[mu_w][(mu_z) - (1)]) != (mu_Parete)) ; 
}
...
bool mu__boolexpr32;
bool mu__boolexpr33;
  if (!(!(mu_topoUscito))) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr33)) mu__boolexpr32 = FALSE ;
  else {
bool mu__boolexpr34;
  if (((mu_y) - (mu_z)) < (0)) mu__boolexpr34 = TRUE ;
  else {
bool mu__boolexpr35;
bool mu__boolexpr36;
bool mu__boolexpr37;
bool mu__boolexpr38;
  if (!(((mu_y) - (mu_z)) > (0))) mu__boolexpr38 = FALSE ;
  else {
bool mu__boolexpr39;
  if ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Ostacolo)) mu__boolexpr39 = TRUE ;
  else {
  mu__boolexpr39 = ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr38 = (mu__boolexpr39) ; 
}
  if (mu__boolexpr38) mu__boolexpr37 = TRUE ;
  else {
  mu__boolexpr37 = (((mu_y) - (mu_z)) <= (0)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = FALSE ;
  else {
bool mu__boolexpr40;
bool mu__boolexpr41;
  if (!(((mu_x) - (mu_w)) < (0))) mu__boolexpr41 = FALSE ;
  else {
bool mu__boolexpr42;
  if ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr42 = TRUE ;
  else {
  mu__boolexpr42 = ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr41 = (mu__boolexpr42) ; 
}
  if (mu__boolexpr41) mu__boolexpr40 = TRUE ;
  else {
  mu__boolexpr40 = (((mu_x) - (mu_w)) >= (0)) ; 
}
  mu__boolexpr36 = (mu__boolexpr40) ; 
}
  if (!(mu__boolexpr36)) mu__boolexpr35 = FALSE ;
  else {
bool mu__boolexpr43;
bool mu__boolexpr44;
  if (!(((mu_x) - (mu_w)) > (0))) mu__boolexpr44 = FALSE ;
  else {
bool mu__boolexpr45;
  if ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr45 = TRUE ;
  else {
  mu__boolexpr45 = ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr44 = (mu__boolexpr45) ; 
}
  if (mu__boolexpr44) mu__boolexpr43 = TRUE ;
  else {
  mu__boolexpr43 = (((mu_x) - (mu_w)) <= (0)) ; 
}
  mu__boolexpr35 = (mu__boolexpr43) ; 
}
  ...
  mu__boolexpr31 = ((mu_stop) == (2)) ; 
}
  if (!(mu__boolexpr31)) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_labirinto[mu_w][(mu_z) - (1)]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_labirinto[mu_w][(mu_z) - (1)]) != (mu_Parete)) ; 
}
	      if (mu__boolexpr29) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr49;
bool mu__boolexpr50;
  if (!(!(mu_topoUscito))) mu__boolexpr50 = FALSE ;
  else {
  mu__boolexpr50 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr50)) mu__boolexpr49 = FALSE ;
  else {
bool mu__boolexpr51;
  if (((mu_y) - (mu_z)) > (0)) mu__boolexpr51 = TRUE ;
  else {
bool mu__boolexpr52;
bool mu__boolexpr53;
bool mu__boolexpr54;
bool mu__boolexpr55;
  if (!(((mu_y) - (mu_z)) < (0))) mu__boolexpr55 = FALSE ;
  else {
bool mu__boolexpr56;
  if ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Ostacolo)) mu__boolexpr56 = TRUE ;
  else {
  mu__boolexpr56 = ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr55 = (mu__boolexpr56) ; 
}
  if (mu__boolexpr55) mu__boolexpr54 = TRUE ;
  else {
  mu__boolexpr54 = (((mu_y) - (mu_z)) >= (0)) ; 
}
  if (!(mu__boolexpr54)) mu__boolexpr53 = FALSE ;
  else {
bool mu__boolexpr57;
bool mu__boolexpr58;
  if (!(((mu_x) - (mu_w)) < (0))) mu__boolexpr58 = FALSE ;
  else {
bool mu__boolexpr59;
  if ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr59 = TRUE ;
  else {
  mu__boolexpr59 = ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr58 = (mu__boolexpr59) ; 
}
  if (mu__boolexpr58) mu__boolexpr57 = TRUE ;
  else {
  mu__boolexpr57 = (((mu_x) - (mu_w)) >= (0)) ; 
}
  mu__boolexpr53 = (mu__boolexpr57) ; 
}
  if (!(mu__boolexpr53)) mu__boolexpr52 = FALSE ;
  else {
bool mu__boolexpr60;
bool mu__boolexpr61;
  if (!(((mu_x) - (mu_w)) > (0))) mu__boolexpr61 = FALSE ;
  else {
bool mu__boolexpr62;
  if ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr62 = TRUE ;
  else {
  mu__boolexpr62 = ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr61 = (mu__boolexpr62) ; 
}
  if (mu__boolexpr61) mu__boolexpr60 = TRUE ;
  else {
  mu__boolexpr60 = (((mu_x) - (mu_w)) <= (0)) ; 
}
  mu__boolexpr52 = (mu__boolexpr60) ; 
}
  ...
  mu__boolexpr48 = ((mu_stop) == (2)) ; 
}
  if (!(mu__boolexpr48)) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = ((mu_labirinto[mu_w][(mu_z) + (1)]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr47)) mu__boolexpr46 = FALSE ;
  else {
  mu__boolexpr46 = ((mu_labirinto[mu_w][(mu_z) + (1)]) != (mu_Parete)) ; 
}
...
bool mu__boolexpr66;
bool mu__boolexpr67;
  if (!(!(mu_topoUscito))) mu__boolexpr67 = FALSE ;
  else {
  mu__boolexpr67 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr67)) mu__boolexpr66 = FALSE ;
  else {
bool mu__boolexpr68;
  if (((mu_y) - (mu_z)) > (0)) mu__boolexpr68 = TRUE ;
  else {
bool mu__boolexpr69;
bool mu__boolexpr70;
bool mu__boolexpr71;
bool mu__boolexpr72;
  if (!(((mu_y) - (mu_z)) < (0))) mu__boolexpr72 = FALSE ;
  else {
bool mu__boolexpr73;
  if ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Ostacolo)) mu__boolexpr73 = TRUE ;
  else {
  mu__boolexpr73 = ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr72 = (mu__boolexpr73) ; 
}
  if (mu__boolexpr72) mu__boolexpr71 = TRUE ;
  else {
  mu__boolexpr71 = (((mu_y) - (mu_z)) >= (0)) ; 
}
  if (!(mu__boolexpr71)) mu__boolexpr70 = FALSE ;
  else {
bool mu__boolexpr74;
bool mu__boolexpr75;
  if (!(((mu_x) - (mu_w)) < (0))) mu__boolexpr75 = FALSE ;
  else {
bool mu__boolexpr76;
  if ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr76 = TRUE ;
  else {
  mu__boolexpr76 = ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr75 = (mu__boolexpr76) ; 
}
  if (mu__boolexpr75) mu__boolexpr74 = TRUE ;
  else {
  mu__boolexpr74 = (((mu_x) - (mu_w)) >= (0)) ; 
}
...
bool mu__boolexpr77;
bool mu__boolexpr78;
  if (!(((mu_x) - (mu_w)) > (0))) mu__boolexpr78 = FALSE ;
  else {
bool mu__boolexpr79;
  if ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr79 = TRUE ;
  else {
  mu__boolexpr79 = ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr78 = (mu__boolexpr79) ; 
}
  if (mu__boolexpr78) mu__boolexpr77 = TRUE ;
  else {
  mu__boolexpr77 = (((mu_x) - (mu_w)) <= (0)) ; 
}
  mu__boolexpr69 = (mu__boolexpr77) ; 
}
  ...
  mu__boolexpr65 = ((mu_stop) == (2)) ; 
}
  if (!(mu__boolexpr65)) mu__boolexpr64 = FALSE ;
  else {
  mu__boolexpr64 = ((mu_labirinto[mu_w][(mu_z) + (1)]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr64)) mu__boolexpr63 = FALSE ;
  else {
  mu__boolexpr63 = ((mu_labirinto[mu_w][(mu_z) + (1)]) != (mu_Parete)) ; 
}
	      if (mu__boolexpr63) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr83;
bool mu__boolexpr84;
  if (!(!(mu_topoUscito))) mu__boolexpr84 = FALSE ;
  else {
  mu__boolexpr84 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr84)) mu__boolexpr83 = FALSE ;
  else {
bool mu__boolexpr85;
  if (((mu_x) - (mu_w)) < (0)) mu__boolexpr85 = TRUE ;
  else {
bool mu__boolexpr86;
bool mu__boolexpr87;
bool mu__boolexpr88;
bool mu__boolexpr89;
  if (!(((mu_y) - (mu_z)) > (0))) mu__boolexpr89 = FALSE ;
  else {
bool mu__boolexpr90;
  if ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Ostacolo)) mu__boolexpr90 = TRUE ;
  else {
  mu__boolexpr90 = ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr89 = (mu__boolexpr90) ; 
}
  if (mu__boolexpr89) mu__boolexpr88 = TRUE ;
  else {
  mu__boolexpr88 = (((mu_y) - (mu_z)) <= (0)) ; 
}
  if (!(mu__boolexpr88)) mu__boolexpr87 = FALSE ;
  else {
bool mu__boolexpr91;
bool mu__boolexpr92;
  if (!(((mu_y) - (mu_z)) < (0))) mu__boolexpr92 = FALSE ;
  else {
bool mu__boolexpr93;
  if ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Ostacolo)) mu__boolexpr93 = TRUE ;
  else {
  mu__boolexpr93 = ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr92 = (mu__boolexpr93) ; 
}
  if (mu__boolexpr92) mu__boolexpr91 = TRUE ;
  else {
  mu__boolexpr91 = (((mu_y) - (mu_z)) >= (0)) ; 
}
  mu__boolexpr87 = (mu__boolexpr91) ; 
}
  if (!(mu__boolexpr87)) mu__boolexpr86 = FALSE ;
  else {
bool mu__boolexpr94;
bool mu__boolexpr95;
  if (!(((mu_x) - (mu_w)) > (0))) mu__boolexpr95 = FALSE ;
  else {
bool mu__boolexpr96;
  if ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr96 = TRUE ;
  else {
  mu__boolexpr96 = ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr95 = (mu__boolexpr96) ; 
}
  if (mu__boolexpr95) mu__boolexpr94 = TRUE ;
  else {
  mu__boolexpr94 = (((mu_x) - (mu_w)) <= (0)) ; 
}
  mu__boolexpr86 = (mu__boolexpr94) ; 
}
  ...
  mu__boolexpr82 = ((mu_stop) == (2)) ; 
}
  if (!(mu__boolexpr82)) mu__boolexpr81 = FALSE ;
  else {
  mu__boolexpr81 = ((mu_labirinto[(mu_w) - (1)][mu_z]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr81)) mu__boolexpr80 = FALSE ;
  else {
  mu__boolexpr80 = ((mu_labirinto[(mu_w) - (1)][mu_z]) != (mu_Parete)) ; 
}
...
bool mu__boolexpr101;
  if (!(!(mu_topoUscito))) mu__boolexpr101 = FALSE ;
  else {
  mu__boolexpr101 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr101)) mu__boolexpr100 = FALSE ;
  else {
bool mu__boolexpr102;
  if (((mu_x) - (mu_w)) < (0)) mu__boolexpr102 = TRUE ;
  else {
bool mu__boolexpr103;
bool mu__boolexpr104;
bool mu__boolexpr105;
bool mu__boolexpr106;
  if (!(((mu_y) - (mu_z)) > (0))) mu__boolexpr106 = FALSE ;
  else {
bool mu__boolexpr107;
  if ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Ostacolo)) mu__boolexpr107 = TRUE ;
  else {
  mu__boolexpr107 = ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr106 = (mu__boolexpr107) ; 
}
  if (mu__boolexpr106) mu__boolexpr105 = TRUE ;
  else {
  mu__boolexpr105 = (((mu_y) - (mu_z)) <= (0)) ; 
}
  if (!(mu__boolexpr105)) mu__boolexpr104 = FALSE ;
  else {
bool mu__boolexpr108;
bool mu__boolexpr109;
  if (!(((mu_y) - (mu_z)) < (0))) mu__boolexpr109 = FALSE ;
  else {
bool mu__boolexpr110;
  if ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Ostacolo)) mu__boolexpr110 = TRUE ;
  else {
  mu__boolexpr110 = ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr109 = (mu__boolexpr110) ; 
}
  if (mu__boolexpr109) mu__boolexpr108 = TRUE ;
  else {
  mu__boolexpr108 = (((mu_y) - (mu_z)) >= (0)) ; 
}
...
bool mu__boolexpr112;
  if (!(((mu_x) - (mu_w)) > (0))) mu__boolexpr112 = FALSE ;
  else {
bool mu__boolexpr113;
  if ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr113 = TRUE ;
  else {
  mu__boolexpr113 = ((mu_labirinto[(mu_w) + (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr112 = (mu__boolexpr113) ; 
}
  if (mu__boolexpr112) mu__boolexpr111 = TRUE ;
  else {
  mu__boolexpr111 = (((mu_x) - (mu_w)) <= (0)) ; 
}
  mu__boolexpr103 = (mu__boolexpr111) ; 
}
  mu__boolexpr102 = (mu__boolexpr103) ; 
}
  mu__boolexpr100 = (mu__boolexpr102) ; 
}
  if (!(mu__boolexpr100)) mu__boolexpr99 = FALSE ;
  else {
  mu__boolexpr99 = ((mu_stop) == (2)) ; 
}
  if (!(mu__boolexpr99)) mu__boolexpr98 = FALSE ;
  else {
  mu__boolexpr98 = ((mu_labirinto[(mu_w) - (1)][mu_z]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr98)) mu__boolexpr97 = FALSE ;
  else {
  mu__boolexpr97 = ((mu_labirinto[(mu_w) - (1)][mu_z]) != (mu_Parete)) ; 
}
	      if (mu__boolexpr97) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr118;
  if (!(!(mu_topoUscito))) mu__boolexpr118 = FALSE ;
  else {
  mu__boolexpr118 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr118)) mu__boolexpr117 = FALSE ;
  else {
bool mu__boolexpr119;
  if (((mu_x) - (mu_w)) > (0)) mu__boolexpr119 = TRUE ;
  else {
bool mu__boolexpr120;
bool mu__boolexpr121;
bool mu__boolexpr122;
bool mu__boolexpr123;
  if (!(((mu_y) - (mu_z)) > (0))) mu__boolexpr123 = FALSE ;
  else {
bool mu__boolexpr124;
  if ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Ostacolo)) mu__boolexpr124 = TRUE ;
  else {
  mu__boolexpr124 = ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr123 = (mu__boolexpr124) ; 
}
  if (mu__boolexpr123) mu__boolexpr122 = TRUE ;
  else {
  mu__boolexpr122 = (((mu_y) - (mu_z)) <= (0)) ; 
}
  if (!(mu__boolexpr122)) mu__boolexpr121 = FALSE ;
  else {
bool mu__boolexpr125;
bool mu__boolexpr126;
  if (!(((mu_y) - (mu_z)) < (0))) mu__boolexpr126 = FALSE ;
  else {
bool mu__boolexpr127;
  if ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Ostacolo)) mu__boolexpr127 = TRUE ;
  else {
  mu__boolexpr127 = ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr126 = (mu__boolexpr127) ; 
}
  if (mu__boolexpr126) mu__boolexpr125 = TRUE ;
  else {
  mu__boolexpr125 = (((mu_y) - (mu_z)) >= (0)) ; 
}
  mu__boolexpr121 = (mu__boolexpr125) ; 
}
  if (!(mu__boolexpr121)) mu__boolexpr120 = FALSE ;
  else {
bool mu__boolexpr128;
bool mu__boolexpr129;
  if (!(((mu_x) - (mu_w)) < (0))) mu__boolexpr129 = FALSE ;
  else {
bool mu__boolexpr130;
  if ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr130 = TRUE ;
  else {
  mu__boolexpr130 = ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr129 = (mu__boolexpr130) ; 
}
  if (mu__boolexpr129) mu__boolexpr128 = TRUE ;
  else {
  mu__boolexpr128 = (((mu_x) - (mu_w)) >= (0)) ; 
}
  mu__boolexpr120 = (mu__boolexpr128) ; 
}
  mu__boolexpr119 = (mu__boolexpr120) ; 
}
  mu__boolexpr117 = (mu__boolexpr119) ; 
}
  if (!(mu__boolexpr117)) mu__boolexpr116 = FALSE ;
  else {
  mu__boolexpr116 = ((mu_stop) == (2)) ; 
}
  if (!(mu__boolexpr116)) mu__boolexpr115 = FALSE ;
  else {
  mu__boolexpr115 = ((mu_labirinto[(mu_w) + (1)][mu_z]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr115)) mu__boolexpr114 = FALSE ;
  else {
  mu__boolexpr114 = ((mu_labirinto[(mu_w) + (1)][mu_z]) != (mu_Parete)) ; 
}
...
bool mu__boolexpr135;
  if (!(!(mu_topoUscito))) mu__boolexpr135 = FALSE ;
  else {
  mu__boolexpr135 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr135)) mu__boolexpr134 = FALSE ;
  else {
bool mu__boolexpr136;
  if (((mu_x) - (mu_w)) > (0)) mu__boolexpr136 = TRUE ;
  else {
bool mu__boolexpr137;
bool mu__boolexpr138;
bool mu__boolexpr139;
bool mu__boolexpr140;
  if (!(((mu_y) - (mu_z)) > (0))) mu__boolexpr140 = FALSE ;
  else {
bool mu__boolexpr141;
  if ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Ostacolo)) mu__boolexpr141 = TRUE ;
  else {
  mu__boolexpr141 = ((mu_labirinto[mu_w][(mu_z) + (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr140 = (mu__boolexpr141) ; 
}
  if (mu__boolexpr140) mu__boolexpr139 = TRUE ;
  else {
  mu__boolexpr139 = (((mu_y) - (mu_z)) <= (0)) ; 
}
  if (!(mu__boolexpr139)) mu__boolexpr138 = FALSE ;
  else {
bool mu__boolexpr142;
bool mu__boolexpr143;
  if (!(((mu_y) - (mu_z)) < (0))) mu__boolexpr143 = FALSE ;
  else {
bool mu__boolexpr144;
  if ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Ostacolo)) mu__boolexpr144 = TRUE ;
  else {
  mu__boolexpr144 = ((mu_labirinto[mu_w][(mu_z) - (1)]) == (mu_Parete)) ; 
}
  mu__boolexpr143 = (mu__boolexpr144) ; 
}
  if (mu__boolexpr143) mu__boolexpr142 = TRUE ;
  else {
  mu__boolexpr142 = (((mu_y) - (mu_z)) >= (0)) ; 
}
...
bool mu__boolexpr146;
  if (!(((mu_x) - (mu_w)) < (0))) mu__boolexpr146 = FALSE ;
  else {
bool mu__boolexpr147;
  if ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Ostacolo)) mu__boolexpr147 = TRUE ;
  else {
  mu__boolexpr147 = ((mu_labirinto[(mu_w) - (1)][mu_z]) == (mu_Parete)) ; 
}
  mu__boolexpr146 = (mu__boolexpr147) ; 
}
  if (mu__boolexpr146) mu__boolexpr145 = TRUE ;
  else {
  mu__boolexpr145 = (((mu_x) - (mu_w)) >= (0)) ; 
}
  mu__boolexpr137 = (mu__boolexpr145) ; 
}
  mu__boolexpr136 = (mu__boolexpr137) ; 
}
  mu__boolexpr134 = (mu__boolexpr136) ; 
}
  if (!(mu__boolexpr134)) mu__boolexpr133 = FALSE ;
  else {
  mu__boolexpr133 = ((mu_stop) == (2)) ; 
}
  if (!(mu__boolexpr133)) mu__boolexpr132 = FALSE ;
  else {
  mu__boolexpr132 = ((mu_labirinto[(mu_w) + (1)][mu_z]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr132)) mu__boolexpr131 = FALSE ;
  else {
  mu__boolexpr131 = ((mu_labirinto[(mu_w) + (1)][mu_z]) != (mu_Parete)) ; 
}
	      if (mu__boolexpr131) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr159;
  ...
  mu__boolexpr157 = ((mu_labirinto[mu_x][(mu_y) + (1)]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr157)) mu__boolexpr156 = FALSE ;
  else {
  mu__boolexpr156 = ((mu_labirinto[mu_x][(mu_y) + (1)]) != (mu_Parete)) ; 
}
...
bool mu__boolexpr163;
  ...
  mu__boolexpr161 = ((mu_labirinto[mu_x][(mu_y) + (1)]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr161)) mu__boolexpr160 = FALSE ;
  else {
  mu__boolexpr160 = ((mu_labirinto[mu_x][(mu_y) + (1)]) != (mu_Parete)) ; 
}
	      if (mu__boolexpr160) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr175;
  if (!(!(mu_topoUscito))) mu__boolexpr175 = FALSE ;
  else {
  mu__boolexpr175 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr175)) mu__boolexpr174 = FALSE ;
  else {
  mu__boolexpr174 = ((mu_stop) != (2)) ; 
}
  if (!(mu__boolexpr174)) mu__boolexpr173 = FALSE ;
  else {
  mu__boolexpr173 = ((mu_labirinto[(mu_x) + (1)][mu_y]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr173)) mu__boolexpr172 = FALSE ;
  else {
  mu__boolexpr172 = ((mu_labirinto[(mu_x) + (1)][mu_y]) != (mu_Parete)) ; 
}
...
bool mu__boolexpr179;
  if (!(!(mu_topoUscito))) mu__boolexpr179 = FALSE ;
  else {
  mu__boolexpr179 = (!(mu_cattura)) ; 
}
  if (!(mu__boolexpr179)) mu__boolexpr178 = FALSE ;
  else {
  mu__boolexpr178 = ((mu_stop) != (2)) ; 
}
  if (!(mu__boolexpr178)) mu__boolexpr177 = FALSE ;
  else {
  mu__boolexpr177 = ((mu_labirinto[(mu_x) + (1)][mu_y]) != (mu_Ostacolo)) ; 
}
  if (!(mu__boolexpr177)) mu__boolexpr176 = FALSE ;
  else {
  mu__boolexpr176 = ((mu_labirinto[(mu_x) + (1)][mu_y]) != (mu_Parete)) ; 
}
	      if (mu__boolexpr176) {
		if ( ( TRUE  ) )
		  return;
